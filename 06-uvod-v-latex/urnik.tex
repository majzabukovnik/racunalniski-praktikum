...
tip (npr. \begin{verbatim}bool\end{verbatim} v C++), kjer bi vrednost \begin{verbatim}true\end{verbatim} predstavljala
dosegljivost, \begin{verbatim}false\end{verbatim} pa zasedenost.
